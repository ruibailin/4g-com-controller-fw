...
/* USER CODE BEGIN PFP */
extern HAL_StatusTypeDef SDK_I2C1_IRQHandler(struct __I2C_HandleTypeDef *hi2c, uint32_t ITFlags, uint32_t ITSources);
/* USER CODE END PFP */
