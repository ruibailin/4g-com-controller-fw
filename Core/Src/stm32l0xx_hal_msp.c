...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspInit 0 */
    ...
    PB7     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = USART1_nCTS_Pin|USART1_nRTS_Pin;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB7     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, USART1_nCTS_Pin|USART1_nRTS_Pin);
  ...
  /* USER CODE END USART4_MspDeInit 0 */
    ...
    PA1     ------> USART4_RX
    */
    HAL_GPIO_DeInit(GPIOA, USART4_TX_Pin|USART4_RX_Pin);
